 ...
 * @author Sandy Dunlop
 */
public class CDropdownTextBox extends CWidget {
    private CTextBox textbox= null;
    private CSymbolButton button = null;
     ...
     * @param text   The initial text to display in the text box.
     */
    public CDropdownTextBox(CContainer parent, String text) {
        ...
        textbox = new CTextBox(null, text);
     ...
     * @return this {@code CDropdownTextBox} instance for method chaining
     */
    public CDropdownTextBox setText(String text) {
